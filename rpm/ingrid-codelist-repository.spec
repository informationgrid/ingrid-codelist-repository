Name:                       ingrid-codelist-repository
Version:                    0.0.0
Release:                    dev
Summary:                    InGrid Codelist Repository
...
%define target              %{buildroot}/opt/ingrid/ingrid-codelist-repository
%define systemd_dir         /usr/lib/systemd/system
%define ingrid_unit_name    ingrid-codelist-repository.service
...
unzip -qq "${WORKSPACE}/target/ingrid-codelist-repository-[0-9]*-installer.jar"
...
# codelist-repository
mkdir -p %{target}/logs
mv ./ingrid-codelist-repository-*/* %{target}
...
%attr(0755,ingrid,ingrid) /opt/ingrid/ingrid-codelist-repository
...
# system.
if [ -f "/etc/systemd/system/ingrid-codelist-repository.service" ]; then
  service ingrid-codelist-repository stop
fi
